...
表达式：`close / Ref(close,60) - 1`；预先固定方向：+1；族：momentum。
假设：过去60日强势股票具有收益延续性。
...
|---|---:|---:|---:|---:|---:|---:|---:|
| train | -0.0169 | -0.0786 | -0.0238 | -0.1086 | 45.81% | 94.97% | 1694 |
| valid | -0.0724 | -0.3623 | -0.0820 | -0.3941 | 32.70% | 90.26% | 477 |
| test | 0.0124 | 0.0605 | -0.0016 | -0.0077 | 52.95% | 95.84% | 865 |
...
|---|---:|---:|---:|---:|---|
| 1日 | 0.0065 | -0.0026 | 0.0314 | 869 | 2020-07-29 00:00:00 |
| 2日 | 0.0089 | -0.0007 | 0.0421 | 868 | 2020-07-28 00:00:00 |
| 5日 | 0.0124 | -0.0016 | 0.0605 | 865 | 2020-07-23 00:00:00 |
| 10日 | 0.0191 | 0.0035 | 0.1013 | 860 | 2020-07-16 00:00:00 |
| 20日 | 0.0282 | 0.0120 | 0.1606 | 850 | 2020-07-02 00:00:00 |
...
|---|---:|---:|---:|
| 2017 | 0.0203 | 0.0893 | 244 |
| 2018 | -0.0032 | -0.0149 | 243 |
| 2019 | -0.0198 | -0.1095 | 244 |
| 2020 | -0.0053 | -0.0291 | 134 |
| bull | -0.0361 | -0.1626 | 269 |
| bear | -0.0177 | -0.0899 | 196 |
| sideways | 0.0296 | 0.1557 | 400 |
...
| volatility | 0.2672 | AVAILABLE |
| turnover | 0.0910 | AVAILABLE |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| valid/top10 | -55.04% | -59.71% | -35.81% | -68.02% | -40.63% | -2.5735 | 22.57% | 5.35% |
| valid/top20 | -41.82% | -46.81% | -26.50% | -59.83% | -27.34% | -2.1619 | 18.48% | 4.38% |
| test/top10 | 45.54% | 22.48% | 5.70% | -40.33% | -2.65% | -0.1769 | 19.87% | 4.72% |
| test/top20 | 58.12% | 37.67% | 9.13% | -35.80% | -0.03% | -0.0026 | 15.96% | 3.79% |
...
另保存假想top20%-bottom20%多空标签差：测试期平均5日价差为0.12%。它不模拟融券、费用或连续持仓，未换算成可交易净收益或年化收益。分组先按当天分数确定，缺失标签数量保存在CSV中。
...
运行ID：`20260903T064735970067Z`；因子ID：`F_eba7afb99b227fdb`。完整定义、指标与原因见同目录`report.json`。
